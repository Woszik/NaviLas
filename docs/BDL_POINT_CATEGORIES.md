...
Osobna warstwa na mapie, **domyślnie wyłączona** (od Beta **0.5.34**). Nie dubluje wyników odpoczynku (15 / amenity 17/19). Wejście: chip **Obiekty BDL** (ekran wyszukiwania w browse albo arkusz filtrów na mapie).
