...
Osobna warstwa na mapie, **domyślnie wyłączona** (od Beta **0.5.34**). Nie dubluje wyników odpoczynku (15 / amenity 17/19). Wejście: rozwijany przycisk **Obiekty BDL** na ekranie 1 oraz belka **Obiekty BDL** w arkuszu **Filtry** na mapie — w Search i Browse (Beta **0.5.42**). Arkusz Filtrów na mapie ma też belki **Tryb** i **Profil** (Nightly 0.5.43). Każda grupa overlay jest niezależna; puste zaznaczenie nic nie rysuje.
