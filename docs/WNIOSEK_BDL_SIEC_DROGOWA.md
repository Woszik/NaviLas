...
Poniżej treść **faktycznie wysłana**. W publicznym repo stopka bez imienia i nazwiska; kontakt: woszi@pm.me.
...
NaviLas na dzień dzisiejszy jeszcze nie jest udostępniony w Google Play. Wersję testową można pobrać z publicznego repozytorium wydań:

https://github.com/Woszik/NaviLas-releases

Na stronie jest plik APK aktualnego wydania. Po instalacji aplikacja sama sprawdza nowszą wersję; aktualizację zatwierdza użytkownik.

Przy pierwszym otwarciu APK oraz podczas aktualizacji Android / Play Protect może ostrzec, że aplikacja pochodzi spoza Sklepu Play — to oczekiwane. Proszę instalować wyłącznie z powyższego repozytorium. W oknie Play Protect: „Więcej szczegółów”, potem instalacja bez skanowania.
